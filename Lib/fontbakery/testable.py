...
class CheckRunContext:
    ...
    @property
    def ufos(self):
        return self.testables_by_type["ufo"]

    @property
    def designspaces(self):
        return self.testables_by_type["designspace"]

    @property
    def glyphs_files(self):
        return self.testables_by_type["glyphs_file"]

    @property
    def metadata_pbs(self):
        return self.testables_by_type["metadata_pb"]
